...
char *pfm_ngets (char *s, int32_t size, FILE *stream)
{
...
/*!
  ...
  - Return Value:
                        - char *   =   basename of the file, for example
...
/*!
  ...
  - Return Value:
                        - char *   =   translated attribute name or the
...
char *pfm_standard_attr_name (int32_t lang, int32_t country, char *name)
{
  static char         new_name[60];
      ...
      if (!strncmp (name, "###", 3))
	{
	  ...
	  switch (res_num)
	    ...
	    case 0:
	      ...
	      break;
	    case 1:
	      strcpy (new_name, "CUBE computed vertical uncert");
	      break;
	    case 2:
	      strcpy (new_name, "CUBE hypothesis strength");
	      break;
	    case 3:
	      strcpy (new_name, "CUBE number of soundings");
	      break;
	    case 4:
	      strcpy (new_name, "Avg of vert. TPE soundings");
	      break;
	    case 5:
	      strcpy (new_name, "Final uncertainty");
	      break;
	    }
