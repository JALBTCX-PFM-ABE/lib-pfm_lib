...
typedef struct
{
  char                     *keyphrase;          /*!<  Key phrase to be matched  */
  char                     *datatype;           /*!<  Data type.  These are the same as the "address" field below with the exception of
                                                      the "string" datatype (which isn't listed) and an optional precision field for floating
                                                      point formats.  For example, f64p15 would convert to %15f.  */
  union
  {
    uint8_t                *uc;                 /*!<  Unsigned character data type  */
    char                   *c;                  /*!<  Signed character data type  */
    uint8_t                *ub;                 /*!<  Unsigned byte integer data type  */
    int8_t                 *by;                 /*!<  Signed byte integer data type  */
    uint8_t                *b;                  /*!<  Boolean data type  */
    int16_t                *i16;                /*!<  Signed 16 bit integer data type  */
    int32_t                *i32;                /*!<  Signed 32 bit integer data type  */
    int64_t                *i64;                /*!<  Signed 64 bit integer data type  */
    uint16_t               *ui16;               /*!<  Unsigned 16 bit integer data type  */
    uint32_t               *ui32;               /*!<  Unsigned 32 bit integer data type  */
    uint64_t               *ui64;               /*!<  Unsigned 64 bit integer data type  */
    float                  *f32;                /*!<  32 bit floating point data type  */
    double                 *f64;                /*!<  64 bit floadting point data type  */
  ...
  } address;                                    /*!<  Address at which to store/retrieve the field(s)  */
  int32_t                  *count;              /*!<  Count of values for repeating fields  */
  int16_t                  version_dependency;  /*!<  Version times 10  */
} KEY;
...
typedef struct
{
  ...
  uint32_t                   bin_header_size;            /*!<  Actual size, in bytes, of the bin header  */
  uint32_t                   record_length;              /*!<  Length of record in bytes  */
  float                      depth_offset;               /*!<  Offset added to depths to make them positive (inverted minimum depth)  */
  uint32_t                   depth_bits;                 /*!<  Number of bits used to store a depth record  */
  float                      depth_scale;                /*!<  Scale depths are multiplied by (i.e. resolution)  */
  uint32_t                   count_bits;                 /*!<  Number of bits used to store the number of points in a bin  */
  uint32_t                   std_bits;                   /*!<  Number of bits used to store a standard deviation value  */
  float                      std_scale;                  /*!<  Scale standard deviations are multiplied by  */
  uint32_t                   edited_flag_bits;           /*!<  Bits used to store the PFM_EDITED flag (pre 4.0)  */
  uint32_t                   checked_flag_bits;          /*!<  Bits used to store the PFM_CHECKED flag (pre 4.0)  */
  uint32_t                   suspect_flag_bits;          /*!<  Bits used to store the PFM_SUSPECT flag (pre 4.0)  */
  uint32_t                   data_flag_bits;             /*!<  Bits used to store the PFM_DATA flag (pre 4.0)  */
  uint32_t                   selected_flag_bits;         /*!<  Bits used to store the PFM_SELECTED flag (pre 4.0)  */
  uint32_t                   class1_flag_bits;           /*!<  Bits used to store the PFM_CLASS1 flag (pre 4.0)  */
  uint32_t                   class2_flag_bits;           /*!<  Bits used to store the PFM_CLASS2 flag (pre 4.0)  */
  uint32_t                   record_pointer_bits;        /*!<  Number of bits used to store a record pointer  */
  uint32_t                   file_number_bits;           /*!<  Number of bits used to store a file number  */
  uint32_t                   ping_number_bits;           /*!<  Number of bits used to store a ping/record number  */
  uint32_t                   line_number_bits;           /*!<  Number of bits used to store a line number  */
  uint32_t                   beam_number_bits;           /*!<  Number of bits used to store a beam/subrecord number  */
  uint32_t                   offset_bits;                /*!<  Number of bits used to store offsets  */
  uint32_t                   validity_bits;              /*!<  Number of bits used to store validity  */
  uint32_t                   bin_attr_bits[NUM_ATTR];    /*!<  Number of bits used to store BIN attributes  */
  uint32_t                   ndx_attr_bits[NUM_ATTR];    /*!<  Number of bits used to store NDX attributes  */
  uint32_t                   horizontal_error_bits;      /*!<  Number of bits used to store horizontal uncertainty  */
  uint32_t                   vertical_error_bits;        /*!<  Number of bits used to store vertical uncertainty  */
  float                      horizontal_error_null;      /*!<  Null value for horizontal uncertainty  */
  float                      vertical_error_null;        /*!<  Null value for vertical uncertainty  */
  int64_t                    coverage_map_address;       /*!<  Address in bytes of the beginning of the coverage map (at the end of the BIN file)  */
  float                      bin_attr_offset[NUM_ATTR];  /*!<  Offset value added to BIN attributes to make them positive  */
  float                      bin_attr_max[NUM_ATTR];     /*!<  Maximum BIN attribute values  */
} BIN_HEADER_DATA;
...
static KEY                     keys[] =
{
...

    {
        "[BIN HEADER SIZE]",
        "ui32",
        {(void *) &header_data.bin_header_size},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 10]",
        "string",
        {(void *) header_data.head.bin_attr_name[10]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 11]",
        "string",
        {(void *) header_data.head.bin_attr_name[11]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE 12]",
        "string",
        {(void *) header_data.head.bin_attr_name[12]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 13]",
        "string",
        {(void *) header_data.head.bin_attr_name[13]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 14]",
        "string",
        {(void *) header_data.head.bin_attr_name[14]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 15]",
        "string",
        {(void *) header_data.head.bin_attr_name[15]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 16]",
        "string",
        {(void *) header_data.head.bin_attr_name[16]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 17]",
        "string",
        {(void *) header_data.head.bin_attr_name[17]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 18]",
        "string",
        {(void *) header_data.head.bin_attr_name[18]},
        NULL,
        0
    },
...

    {
        "[BIN ATTRIBUTE 19]",
        "string",
        {(void *) header_data.head.bin_attr_name[19]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE OFFSET 10]",
        "f32",
        {(void *) &header_data.bin_attr_offset[10]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 11]",
        "f32",
        {(void *) &header_data.bin_attr_offset[11]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 12]",
        "f32",
        {(void *) &header_data.bin_attr_offset[12]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 13]",
        "f32",
        {(void *) &header_data.bin_attr_offset[13]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 14]",
        "f32",
        {(void *) &header_data.bin_attr_offset[14]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 15]",
        "f32",
        {(void *) &header_data.bin_attr_offset[15]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 16]",
        "f32",
        {(void *) &header_data.bin_attr_offset[16]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 17]",
        "f32",
        {(void *) &header_data.bin_attr_offset[17]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 18]",
        "f32",
        {(void *) &header_data.bin_attr_offset[18]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE OFFSET 19]",
        "f32",
        {(void *) &header_data.bin_attr_offset[19]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 10]",
        "f32",
        {(void *) &header_data.bin_attr_max[10]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE MAX 11]",
        "f32",
        {(void *) &header_data.bin_attr_max[11]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 12]",
        "f32",
        {(void *) &header_data.bin_attr_max[12]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 13]",
        "f32",
        {(void *) &header_data.bin_attr_max[13]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 14]",
        "f32",
        {(void *) &header_data.bin_attr_max[14]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 15]",
        "f32",
        {(void *) &header_data.bin_attr_max[15]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 16]",
        "f32",
        {(void *) &header_data.bin_attr_max[16]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 17]",
        "f32",
        {(void *) &header_data.bin_attr_max[17]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 18]",
        "f32",
        {(void *) &header_data.bin_attr_max[18]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE MAX 19]",
        "f32",
        {(void *) &header_data.bin_attr_max[19]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE NULL 10]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[10]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 11]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[11]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 12]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[12]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 13]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[13]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 14]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[14]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 15]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[15]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 16]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[16]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 17]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[17]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 18]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[18]},
        NULL,
        0
    },

    {
        "[BIN ATTRIBUTE NULL 19]",
        "f32",
        {(void *) &header_data.head.bin_attr_null[19]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 10]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[10]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 10]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[10]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 11]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[11]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 11]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[11]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 12]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[12]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 12]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[12]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 13]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[13]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 13]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[13]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 14]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[14]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 14]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[14]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 15]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[15]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 15]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[15]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 16]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[16]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 16]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[16]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 17]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[17]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 17]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[17]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 18]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[18]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 18]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[18]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM BIN ATTRIBUTE 19]",
        "f32",
        {(void *) &header_data.head.min_bin_attr[19]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM BIN ATTRIBUTE 19]",
        "f32",
        {(void *) &header_data.head.max_bin_attr[19]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 10]",
        "i32",
        {(void *) &header_data.bin_attr_bits[10]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 11]",
        "i32",
        {(void *) &header_data.bin_attr_bits[11]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 12]",
        "i32",
        {(void *) &header_data.bin_attr_bits[12]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 13]",
        "i32",
        {(void *) &header_data.bin_attr_bits[13]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 14]",
        "i32",
        {(void *) &header_data.bin_attr_bits[14]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 15]",
        "i32",
        {(void *) &header_data.bin_attr_bits[15]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 16]",
        "i32",
        {(void *) &header_data.bin_attr_bits[16]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 17]",
        "i32",
        {(void *) &header_data.bin_attr_bits[17]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 18]",
        "i32",
        {(void *) &header_data.bin_attr_bits[18]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE BITS 19]",
        "i32",
        {(void *) &header_data.bin_attr_bits[19]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 10]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[10]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 11]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[11]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 12]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[12]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 13]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[13]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 14]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[14]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 15]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[15]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 16]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[16]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 17]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[17]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 18]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[18]},
        NULL,
        0
    },
    ...
    {
        "[BIN ATTRIBUTE SCALE 19]",
        "f32",
        {(void *) &header_data.head.bin_attr_scale[19]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 10]",
        "string",
        {(void *) header_data.head.ndx_attr_name[10]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 11]",
        "string",
        {(void *) header_data.head.ndx_attr_name[11]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 12]",
        "string",
        {(void *) header_data.head.ndx_attr_name[12]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 13]",
        "string",
        {(void *) header_data.head.ndx_attr_name[13]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 14]",
        "string",
        {(void *) header_data.head.ndx_attr_name[14]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 15]",
        "string",
        {(void *) header_data.head.ndx_attr_name[15]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 16]",
        "string",
        {(void *) header_data.head.ndx_attr_name[16]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 17]",
        "string",
        {(void *) header_data.head.ndx_attr_name[17]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 18]",
        "string",
        {(void *) header_data.head.ndx_attr_name[18]},
        NULL,
        0
    },
...

    {
        "[NDX ATTRIBUTE 19]",
        "string",
        {(void *) header_data.head.ndx_attr_name[19]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 10]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[10]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 10]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[10]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 11]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[11]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 11]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[11]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 12]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[12]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 12]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[12]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 13]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[13]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 13]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[13]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 14]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[14]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 14]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[14]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 15]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[15]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 15]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[15]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 16]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[16]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 16]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[16]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 17]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[17]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 17]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[17]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 18]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[18]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 18]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[18]},
        NULL,
        0
    },
    ...
    {
        "[MINIMUM NDX ATTRIBUTE 19]",
        "f32",
        {(void *) &header_data.head.min_ndx_attr[19]},
        NULL,
        0
    },
    ...
    {
        "[MAXIMUM NDX ATTRIBUTE 19]",
        "f32",
        {(void *) &header_data.head.max_ndx_attr[19]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 10]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[10]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 11]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[11]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 12]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[12]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 13]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[13]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 14]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[14]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 15]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[15]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 16]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[16]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 17]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[17]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 18]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[18]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE BITS 19]",
        "i32",
        {(void *) &header_data.ndx_attr_bits[19]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 10]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[10]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 11]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[11]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 12]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[12]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 13]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[13]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 14]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[14]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 15]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[15]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 16]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[16]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 17]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[17]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 18]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[18]},
        NULL,
        0
    },
    ...
    {
        "[NDX ATTRIBUTE SCALE 19]",
        "f32",
        {(void *) &header_data.head.ndx_attr_scale[19]},
        NULL,
        0
    },
...

    {
        "[USER FLAG 6 NAME]",
        "string",
        {(void *) header_data.head.user_flag_name[5]},
        NULL,
        0
    },
...

    {
        "[USER FLAG 7 NAME]",
        "string",
        {(void *) header_data.head.user_flag_name[6]},
        NULL,
        0
    },
...

    {
        "[USER FLAG 8 NAME]",
        "string",
        {(void *) header_data.head.user_flag_name[7]},
        NULL,
        0
    },
...

    {
        "[USER FLAG 9 NAME]",
        "string",
        {(void *) header_data.head.user_flag_name[8]},
        NULL,
        0
    },
...

    {
        "[USER FLAG 10 NAME]",
        "string",
        {(void *) header_data.head.user_flag_name[9]},
        NULL,
        0
    },
